...
def create_mednextv1_custom(num_input_channels, num_classes, kernel_size=3, ds=False):
...
if __name__ == "__main__":
    """function name : create_mednextv1_custom(num_input_channels, num_classes, kernel_size=3, ds=False)
    custom model with 
        in_channels = 4, 
        n_channels = 16,
        n_classes = 4, 
        ...
        block_counts = [2,2,2,2,2,2,2,2,2]
    """
    model = create_mednextv1_custom(1, 3, 3, False)
    print(model)